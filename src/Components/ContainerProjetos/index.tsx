  ...
  return (
    <div className={styles.container}>
        ...
        <div style={{display:'flex', width: "100%", justifyContent:'space-evenly'}}>   
            <BotaoNav voltar location='/'>{linguagem === 'PT' ? 'Voltar para home' : 'Home page'}</BotaoNav>
            <BotaoNav avancar location='/contatos'>{linguagem === 'PT' ? 'Ir para contatos' : 'Contact page'}</BotaoNav>
        </div>
    </div>
  )
}
